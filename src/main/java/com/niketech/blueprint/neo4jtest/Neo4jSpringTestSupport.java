...
/**
 * Base class that can be extended by unit tests that wish to test Neo4j functionality with Spring.
 */
public abstract class Neo4jSpringTestSupport extends AbstractJUnit4SpringContextTests {
